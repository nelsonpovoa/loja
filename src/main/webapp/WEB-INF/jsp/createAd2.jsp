	...
	<div style="text-align: center;width: 97%">
		...
		<div class="container" style="text-align: center;margin: auto;">
			...
			<div class="row">
				...
				<div class="col-sm-3" style="font-weight: bold;">
					<input class="form-check-input" type="checkbox" value="" id="checkActivoAd" <c:if test="${prod.activo}">checked</c:if>>
					      <label class="form-check-label" for="checkActivoAd">
					        Activo
					      </label>
				</div>
				<div class="col-sm-3" style="font-weight: bold;" nowrap>

					<input class="form-check-input" type="checkbox" value="" id="checkNovidadeAd" <c:if test="${prod.novidade}">checked</c:if>>
					<label class="form-check-label" for="checkNovidadeAd">
				        Novidade
				      </label>
				</div>
...
<div class="row">
				...
				<div class="col-sm-12">
	<select id="multipleSelectAd" name="subTipo"  class="form-control 2col active" style="width: 100%">
<option value=""> - Selecione - </option>
...
function create(){
	...
	var name = $("#namead");
	//var name = document.getElementById("namead");
	alert(name.val())
	...
	var selectedValuesSubTipo = $('#multipleSelectAd')
	//alert(selectedValuesSubTipo.val())
	...
	var checkActivo = document.getElementById("checkActivoAd");
	var checkNovidade = document.getElementById("checkNovidadeAd");
	
	//alert(checkNovidade.checked)
	console.log(checkActivo)
	console.log(checkActivo.checked)
	var obj =  {
			"id" : prodId,
			"ano" : ano.val(),
