...
<div id="root">
	<div class="">
		...
		<div
			...
			<div class="TopBarMenuLegacy2_buttonbar__bp7RP">
	...
	<div>
		<div
			class="ResetPasswordRequest_modal__Bx5rw ResetPasswordRequest_show__emRY8 ResetPasswordRequest_full_page__gAuI7">
			<div class="ResetPasswordRequest_modal_inner__42fZy ">
				<h1>Recuperar a sua password</h1>
				<p class="ResetPasswordRequest_instructions__8GJHe">Se o seu email existir, um email 
				com as instruções lhe será enviado para recuperar a sua password.</p>
				<form>
					<div>
				...
				<div
					class="ResetPasswordRequest_cta_bottom_box__gSd9O ResetPasswordRequest_cta_bottom_box_button_reset__8s-FY">
					<div>
						<button
							class="Button_button__URNp+ Button_primary__d2Jt3 Button_fullwidth__0HLEu Button_disabled__MpJSA"
							disabled="">
							<span>recuperar password</span>
						</button>
						<div class="ResetPasswordRequest_return_to_login_wrapper__-jz5P">
							<a href="/">Voltar à pagina de autenticação</a>
						</div>
					</div>
				</div>
			</div>
		</div>
		<div class="TermsFooter_terms_footer__9tugK "
