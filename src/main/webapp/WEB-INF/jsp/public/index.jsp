...
.carousel-control-prev-icon {
  ...
  */
  ...
  background-image: linear-gradient(90deg,#f3b94a,#bcc453,#84c973,#4ac79a,#00c1bc);
  height: 10px;
  width: 100%;
}
...
<script type="text/javascript">
	...
	function showPopup(id){
		...
		$("#myModalCenterTitle").html("Imagem");
		$('.modal-body').html("");
	...
	function aplicaFiltro(obj) {
		...
		if (obj.value <4){
			...
			$( "#mainpage" ).load( "/s/ordenacao/"+tipo+"/"+subTipo+"/"+obj.value+"/0", function(response, status, xhr) {
			  	if ( status == "error" ) {
	...
	function showPopupNewEvent(op, state){
		const option = localStorage.getItem("myOptionEntryScreen");
		if (op==0 && (option == null || option == false)) {
		
			$("#myFirstModalTitle").html("Feliz Ano Novo");
			$('.myfirst-modal-body').html("");
			
			var valor = Math.floor(Math.random() * 3)
			
			var image = "happy-2024.jpg";
			if (valor == 1){
				image = "happy-2024_2.jpg";
			}else if (valor == 2){
				image = "happy-new-year.jpg";
			}else{
				image = "happy-2024_4.jpg";
			}
			image = "happy-2024_3.png";
			//$( ".myfirst-modal-body" ).html("<p style=\"text-align: center;\"> <img src=\"/img/"+image+"\" width='100%'> </p>");
			
			// VIDEO
			$( ".myfirst-modal-body" ).html("<p style=\"text-align: center;\"> <iframe allow='fullscreen' frameBorder='0' width='90%' height='800' src='https://giphy.com/embed/BX3XAFnjSiXQPNBakA/video' width='480'></iframe> </p>");
			
	
		    $('#myFirstModal').modal('show');
		}else {
			if (op == 1){
				localStorage.setItem("myOptionEntryScreen", state);
			}
		}
	}
	...
	function pesquisa(btn) {
		...
		$( "#mainpage" ).load( "/pesqpornome", 
				{ "fieldPesq" : fieldPesq, "field" : nomePesq.val(), 
				"ordenacao" : ordenacao, "vista" : 0, "tipo" : tipo, "subTipo" : subTipo}, function(response, status, xhr) {
					if ( status == "error" ) {
					    var msg = "Erro! Ocorreu o seguinte erro: ";
					    $("#error").html( msg + xhr.status + " " + xhr.statusText );
						$("#error").show();
...
<body id="page-top" onload="showPopupNewEvent(0, false)">
	...
	<div id="error" class="loading" style="display: none;width: 150px;text-align: center;vertical-align: bottom;">
		ERRO!
	</div>
...
<!-- Divider -->
	...
	<!-- div contactos -->
			...
			<div style="display: inline-block;text-align: center">
	            ...
	            <a href="https://www.facebook.com/profile.php?id=100092634155633" target="_blank" title="Entrar Facebook Pessoal">
			...
			<div>
				...
				<a href="https://facebook.com/StartBootstrap" target="_blank" rel="noopener" title="Facebook" class="icon-list-social-link">
...
<!-- 						<svg role="img" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook" class="svg-inline--fa fa-facebook" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"></path></svg> -->
		...
		<div class="container" style="padding-top: 50px">
			<div class="connect"><h6 class="connect__heading">Entrar com</h6>
				<ul data-role="login-menu" class="services login-buttons">
<!-- 					<li class="auth-disqus"><button type="button" data-action="auth:disqus" title="Disqus" class="connect__button" aria-label="Login with Disqus"><i class="icon-disqus"></i></button></li> -->
					<li class="auth-facebook"><button type="button" data-action="auth:facebook" title="Facebook" class="connect__button" aria-label="Login with Facebook"><i class="icon-facebook-circle"></i></button></li>
					<li class="auth-twitter"><button type="button" data-action="auth:twitter" title="Twitter" class="connect__button" aria-label="Login with Twitter"><i class="icon-twitter-circle"></i></button></li>
					<li class="auth-google"><button type="button" data-action="auth:google" title="Google" class="connect__button" aria-label="Login with Google"><i class="icon-google-plus-circle"></i></button></li>
				</ul>
			</div>
				      ...
				      <div class="col-lg-12 col-md-12 mx-auto">
				        <ul class="list-inline text-center">
				          ...
				          <li class="list-inline-item">
				            <a href="mailto:heroinamiranda@gmail.com" title="Enviar Email">
				              <span class="fa-stack fa-lg">
				                <i class="fas fa-circle fa-stack-2x"></i> 
				          ...
				          <li class="list-inline-item">
				            <a href="https://twitter.com/SBootstrap">
				              <span class="fa-stack fa-lg">
<!-- 				                <svg class="svg-inline--fa fa-circle fa-w-16 fa-stack-2x" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> -->
				                <i class="fas fa-circle fa-stack-2x"></i> 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form
                        class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="" onsubmit="return false;">
                        <div class="input-group">
                            <input id="inpSearchAll1" type="text" class="form-control bg-light border-0 small" placeholder="Procurar por..."
                                aria-label="Search" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="button" onclick="searchOnAllProducts('inpSearchAll1')">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
                                ...
                                <form class="form-inline mr-auto w-100 navbar-search" action="" onsubmit="return false;">
                                    <div class="input-group">
                                        <input id="inpSearchAll2" type="text" class="form-control bg-light border-0 small"
                                            placeholder="Procurar por..." aria-label="Procura"
                                            aria-describedby="basic-addon2">
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="button" onclick="searchOnAllProducts('inpSearchAll2')">
                                                <i class="fas fa-search fa-sm"></i>
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link" href="/login" id="userDropdown" role="button"
                                >
                                <span class="mr-2 d-lg-inline text-gray-600">Entrar &nbsp;</span>
...
%>
	...
	<div class="section--divider gradient-bar "></div>
...
%>
 ...
 <% } %>               
    ...
    <!-- Modal -->
<div class="modal fade modal-resizable" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myModalCenterTitle">Anúncio</h5>
    ...
    <!-- Modal Alerta -->
	<div class="modal fade modal-resizable" id="myFirstModal" tabindex="-1" role="dialog" aria-labelledby="myFirstModalTitle" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="myFirstModalTitle">Anúncio</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="myfirst-modal-body">
	        ...
	      </div>
	      <div class="modal-footer" style="display: block;">
	      	<div class="row">
	      		<div class="col-8 col-md-8 text-left">
	      			...
	      			<input class="form-check-input" id="chkValidar" type="checkbox" onclick="showPopupNewEvent(1, this.checked)">
	      			<label class="form-check-label" for="chkValidar" style="color: gray">
					    Selecione para nao voltar a aparecer
					</label>
					</div>
	      		</div>
	      		<div class="col-4 col-md-4 text-right">
	      			<button type="button" id="myFirstBtnClose" class="btn btn-primary" data-dismiss="modal">Fechar</button>
	      		</div>
	      	</div>
    ...
    <span class="sr-only">Next</span>
 		...
 		--%>
            ...
            <div class="carousel-indicators">
                <button type="button" data-target="#carouselMain" data-slide-to="0" class="active"></button>
                <button type="button" data-target="#carouselMain" data-slide-to="1"></button>
                <button type="button" data-target="#carouselMain" data-slide-to="2"></button>
            </div>
            <div class="carousel-inner">
                ...
                <div class="carousel-item active text-center active" data-bs-interval="5000">
                    ...
                    <div class="carousel-caption" style="text-align:center; font-size: 16px;font-weight:bold; padding-top: 10px">
					    <h4><a href="https://www.facebook.com/heroina.heroina.353" target="_blank">Facebook</a>
					    
					    	<br> <br>
					    	<p style="color: black;font-size: 12px;color: black;background-color: white;border-radius: 10px;">(aceda ao meu facebook ou consulte neste site)</p>
					    	
					    </h4>
					    
<!-- 					    <p style="text-align:center; color: black;background-color: white;border-radius: 10px;width: 80%">(aceda ao meu facebook ou consulte neste site)</p> -->
					</div>
                </div>
...
<!--                     <img src="/img/slides/slide01small.jpg" alt="" class="img-fluid d-block d-md-none" style="height: 150px"> -->
                    ...
                    <img src="/img/slides/ImageFilipa2.png" alt="" class="img-fluid d-none d-md-block" style="height: 150px">
                    <img src="/img/slides/ImageFilipa5Small.png" alt="" class="img-fluid d-block d-md-none" style="height: 150px">
                    <div class="carousel-caption " style="text-align:center; font-size: 16px;padding-top: 10px">
					    <h4><a href="https://www.facebook.com/heroina.heroina.353" target="_blank">Facebook</a></h4>
					    <br>
					    <p style="color: black;font-size: 12px">(aceda ao meu facebook ou consulte neste site)</p>
					</div>
                </div>
            
            <%-- 
                <div class="carousel-item active text-center active" data-bs-interval="3000">
                    <img src="/img/slides/slide012.jpg" alt="" class="img-fluid d-none d-md-block" style="height: 150px">
                    <img src="/img/slides/slide01small.jpg" alt="" class="img-fluid d-block d-md-none" style="height: 150px">
                </div>
            ...
            <a class="carousel-control-prev" href="#carouselMain" role="button" data-slide="prev">
                <span class="carousel-control-prev-icon" style="color: black;border: 2px solid black"></span>
                <span class="visually-hidden">Anterior</span>
            </a>
            <a class="carousel-control-next" href="#carouselMain" role="button" data-slide="next">
                <span class="carousel-control-next-icon" style="color: black;border: 2px solid black"></span>
    ...
    <script src="/bootstrap-4.1.3/js/dist/util.js"></script>
    <script src="/bootstrap-4.1.3/js/dist/carousel.js"></script>
