			...
			<div
				...
				<div
					...
					<a class="TopBarMenuLegacy2_logo__08SSu"
						href="https://w3schools.com" aria-label="W3Schools logo"><svg
							...
							<form>
								<div class="EmailInput_input_wrapper__taDTk -fif_wrp">
									<div class="EmailInput_label_wrapper__83g-2 -fif_label_wrp">
										<label for="email">Email</label><span>Already have an
								...
								<div class="PasswordInput_input_wrapper__uSskp -fif_wrp">
									<div class="PasswordInput_label_wrapper__nvF4r -fif_label_wrp">
										<label for="new-password">Password</label><span
											class="PasswordInput_show_pwd_btn__Ncc9S"><svg
												aria-hidden="true" focusable="false" data-prefix="far"
												data-icon="eye" class="svg-inline--fa fa-eye fa-w-18"
												role="img" xmlns="http://www.w3.org/2000/svg" width="15"
												height="14" viewBox="0 0 640 512">
												<path fill="currentColor"
													d="M288 144a110.94 110.94 0 0 0-31.24 5 55.4 55.4 0 0 1 7.24 27 56 56 0 0 1-56 56 55.4 55.4 0 0 1-27-7.24A111.71 111.71 0 1 0 288 144zm284.52 97.4C518.29 135.59 410.93 64 288 64S57.68 135.64 3.48 241.41a32.35 32.35 0 0 0 0 29.19C57.71 376.41 165.07 448 288 448s230.32-71.64 284.52-177.41a32.35 32.35 0 0 0 0-29.19zM288 400c-98.65 0-189.09-55-237.93-144C98.91 167 189.34 112 288 112s189.09 55 237.93 144C477.1 345 386.66 400 288 400z"></path></svg>Show
										</span>
									</div>
									<div class="-fif_input_wrp">
										<input class="PasswordInput_input_field__EWMIU undefined"
											name="new-password" type="password" placeholder=""
											id="new-password" value="">
									</div>
								</div>
							</form>
						</div>
						<div class="ValidationHelper_pwd_validation__SD+qY">
							<li
								class="ValidationElement_validation__zlNSM ValidationElement_invalid__+jaJI"><svg
									width="8" height="8" viewBox="0 0 8 8" fill="none"
									xmlns="http://www.w3.org/2000/svg">
									<circle cx="4" cy="4" r="4" fill="#04AA6D" fill-opacity="1.0"></circle></svg>One
							...
							<li
								class="ValidationElement_validation__zlNSM ValidationElement_invalid__+jaJI"><svg
									width="8" height="8" viewBox="0 0 8 8" fill="none"
									xmlns="http://www.w3.org/2000/svg">
									<circle cx="4" cy="4" r="4" fill="#04AA6D" fill-opacity="1.0"></circle></svg>8
								characters minimum</li>
						</div>
						<div id="emailConsentCheckBox-wrapper"
							class="CheckBox -size-md -placement-left -checked"
							style="padding: 15px 0px 10px;">
							<div class="-inner-wrapper">
								<input id="emailConsentCheckBox" type="checkbox" role="checkbox"
									name="emailConsentCheckBox" class="-input" aria-checked="true"
									checked=""><label for="emailConsentCheckBox"
									class="-label"><span class="-alt-checkbox"><svg
											xmlns="http://www.w3.org/2000/svg" width="16" height="16"
											viewBox="0 0 16 16" fill="currentColor"
											class="-alt-checkmark">
											<path
												d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path></svg></span>Email
									me with news and updates</label>
							</div>
						</div>
						<div class="LoginModal_cta_bottom_box__wU1AF">
							...
							<div>
								<div class="LoginModal_cta_bottom_box_divider__jEfL3">
									<span class="LoginModal_cta_bottom_box_divider_text__wyauO">or</span>
								</div>
								<div>
									<button
										...
										<div class="ButtonV2_text__hrU4c">Continue with Facebook</div>
									</button>
								</div>
								<button
									...
									<div
										class="ButtonV2_text__hrU4c LoginModal_cta_bottom_box_button_google_login_text__25VDY">Continue
										with Google</div>
								</button>
								<button
							...
							<div class="LoginModal_terms__al-RT">
								By clicking the “Sign up for free” button or using any of the
								social login options, you are creating an account, and agree to
								W3Schools' <a
									href="https://www.w3schools.com/about/about_copyright.asp"
									target="_blank" rel="noopener noreferrer">Terms of Service</a>
								and <a href="https://www.w3schools.com/about/about_privacy.asp"
