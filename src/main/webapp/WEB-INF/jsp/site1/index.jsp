...
<!--                         <h6 class="collapse-header">Custom Utilities:</h6> -->
                        ...
                        <a class="collapse-item" href="#" onclick="go(4)">Contactos</a>
...
<!-- Divider -->
	...
	<!-- div contactos -->
            <div class="text-center d-none d-md-inline" style="color: white;padding-top: 100px;">
            	<span style="font-weight: bold;">CONTACTOS </span> <br> <span style="font-size: 10pt">960271478 <br> 252601430</span> <br>
