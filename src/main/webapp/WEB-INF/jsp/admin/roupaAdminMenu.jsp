...
%>
        ...
        <div class="side">
            ...
            <div class="widget">
                <h6 class="title">Gest�o</h6>
                <ul class="link">
                    <li><a href="#" onclick="go(1)">Produtos</a></li>
                    <li><a href="#" onclick="go(2)">Produtos 2</a></li>
                    <li><a href="#" onclick="go(3)">Produtos 3</a></li>
                    <li><a href="#" onclick="go(4)">Contactos</a></li>
                    <li><a href="#">Blog</a></li>
...
%>
 ...
 <li class="nav-item dropdown">
		<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" >Dropdowns</a>
		<ul class="dropdown-menu">
        	...
        	<div class="row">
        		...
        		<div class="col-sm-6 text-left">
        			...
        			<div class="col-sm-1" style="border: 1px solid blue">
	        			<a href="#" onclick="removeAdBS(<c:out value="${prod.id}"/>, '<c:out value="${prod.referencia}"/>')">
